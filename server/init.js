...
const { InsertUser } = require("./server/query/insert");

const PROJECT_ROOT = path.join(__dirname, "/");
const LOCK_FILE_PATH = path.join(PROJECT_ROOT, "install.lock");

const db = require(PROJECT_ROOT + "server/connect/connection");
...
const insertAdminUser = async () => {
    const { ADMIN_EMAIL, ADMIN_PWSD, ADMIN_FIRSTNAME, ADMIN_LASTNAME } = process.env;
    const user = {
